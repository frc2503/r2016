...
import org.usfirst.frc.team2503.websocket.exceptions.WebsocketNotConnectedException;
...
public class WebSocketImpl implements WebSocket {
	...
	/* The queue of buffers that need to get sent to the client.
	 */
	public final BlockingQueue<ByteBuffer> outQueue;

	/* The queue of buffers that need to get processed.
	 */
	 ...
	 * 
	 * TODO add reset worker functionality?
	 */
	public volatile WebSocketWorker workerThread;

	
	/* In flush and close state?
	 * 
	 * True if further buffers can be sent.
	 */
